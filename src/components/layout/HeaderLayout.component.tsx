    ...
    <Grid className="justify-between">
      ...
      <Grid.Col span={4}>
        <Group className="mx-auto w-fit h-full gap-12">
          <NavbarMenu pathname={pathname} label="Beranda" href={ROUTES.HOME} />
          <NavbarMenu pathname={pathname} label="Quiz" href={ROUTES.QUIZ} />
          <NavbarMenu pathname={pathname} label="Leaderboard" href={ROUTES.LEADERBOARD} />
        </Group>
      </Grid.Col>
      <Grid.Col span={4}>
        <Group className="h-full justify-end">
          {isLoggedIn ? (
            ...
            >
              ...
              <NavbarMenu pathname={pathname} label="Log In" href={ROUTES.LOGIN} />
            </>
          )}
        </Group>
      </Grid.Col>
